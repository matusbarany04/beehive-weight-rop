<script>
     ...
     */
    export let updateSettings =  () => { return {status: "success"}};
    /**
...
<div
        use:dragMe
        class="root flex aspect-square h-full w-full justify-center overflow-hidden rounded-md align-middle {'root_' + theme}"
