...
export class BeehiveObj {
   ...
   static  _filterUniquePairs(inputArray) {
    ...
    static getUnionOfCurrentDataTypesAsKeyValuePairs(beehiveIdList, graphable = false) {
        let allDataTypes = []
        ...
        return BeehiveObj._filterUniquePairs(staticFuncs.arrayToKeyValuePairs(allDataTypes));
    }
