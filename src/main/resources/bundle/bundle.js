var app = (function () {
	...
	/* dashboard\app\component\GetList.svelte generated by Svelte v4.2.0 */
	...
	/* components\TestComponent.svelte generated by Svelte v4.2.0 */
	...
	function create_fragment$8(ctx) {
		...
		return {
			c() {
				h1 = element("h1");
				h1.textContent = "Test component in action !!!!";
	...
	var css_248z$1 = ".image.svelte-4rekfq{height:20px;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;aspect-ratio:1/1;background-size:contain;background-repeat:no-repeat;-webkit-mask-size:100%;mask-size:100%;background-color:var(--icon-color, black)}.root.svelte-4rekfq{padding:1.05rem 1rem;height:1.5rem;border-radius:10px;display:flex;width:-moz-min-content;width:min-content;align-items:center;justify-content:center;transition-duration:100ms;cursor:pointer;gap:0.5rem}.root.svelte-4rekfq:hover{transform:scale(1.02)}.root.svelte-4rekfq:active{transform:scale(0.98)}";
	styleInject(css_248z$1);

	/* components\Button.svelte generated by Svelte v4.2.0 */
	...
	function create_if_block(ctx) {
		...
		return {
			c() {
				div = element("div");
				attr(div, "class", "image svelte-4rekfq");
				set_style(div, "mask-image", "url(" + /*image*/ ctx[2] + ")");
				set_style(div, "-webkit-mask-image", "url(/" + /*image*/ ctx[2] + ")");
			},
			m(target, anchor) {
	...
	function create_fragment$7(ctx) {
		...
		return {
			c() {
				...
				p = element("p");
				t1 = text(/*text*/ ctx[0]);
				attr(p, "class", "text text-ellipsis no_wrap whitespace-nowrap svelte-4rekfq");
				attr(button, "type", /*clickType*/ ctx[4]);
				attr(button, "class", button_class_value = "" + (null_to_empty("root " + /*type*/ ctx[1]) + " svelte-4rekfq"));
			},
			m(target, anchor) {
			...
			p(ctx, [dirty]) {
				...
				if (dirty & /*clickType*/ 16) {
					attr(button, "type", /*clickType*/ ctx[4]);
				}

				if (dirty & /*type*/ 2 && button_class_value !== (button_class_value = "" + (null_to_empty("root " + /*type*/ ctx[1]) + " svelte-4rekfq"))) {
	...
	function instance$4($$self, $$props, $$invalidate) {
		...
		$$self.$$set = $$props => {
			...
			if ('clickType' in $$props) $$invalidate(4, clickType = $$props.clickType);
			if ('onClick' in $$props) $$invalidate(5, onClick = $$props.onClick);
		};

		return [text, type, image, link, clickType, onClick, click_handler];
	}
	...
	/* dashboard\app\pages\Homepage.svelte generated by Svelte v4.2.0 */
	...
	function create_fragment$6(ctx) {
		...
		button = new Button({
				props: { onClick: logout, text: "Log Out" }
			});
		...
		return {
			c() {
				h10 = element("h1");
				h10.textContent = "Home sweet Homes";
				t1 = space();
				div = element("div");
				div.innerHTML = `<h1>hello icon heart</h1>`;
				t3 = space();
	...
	function logout() {
		fetch("/logoutUser", { method: "POST" }).then(response => response.json()).then(response => {
	...
	/* dashboard\app\pages\Notfound.svelte generated by Svelte v4.2.0 */
	...
	/* dashboard\app\pages\Help.svelte generated by Svelte v4.2.0 */
	...
	function create_fragment$4(ctx) {
		...
		return {
			c() {
				h1 = element("h1");
				h1.textContent = "pomoc !!!";
				attr(h1, "class", "text-center text-5xl");
			},
			m(target, anchor) {
				insert(target, h1, anchor);
			},
	...
	/* dashboard\app\routing\Router.svelte generated by Svelte v4.2.0 */
	...
	const prefix = createPrefixStore();

	/* components\RouterLink.svelte generated by Svelte v4.2.0 */
	...
	function create_fragment$2(ctx) {
		...
		return {
			c() {
				...
				attr(a, "class", "text-slate-500 text-xl");
				attr(a, "href", a_href_value = "" + ((!/*baseRoute*/ ctx[1] ? /*currentPrefix*/ ctx[2] : '') + /*url*/ ctx[0]));
			},
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = listen(a, "click", prevent_default(/*changeRoute*/ ctx[3]));
					mounted = true;
				}
			},
			p(ctx, [dirty]) {
				...
				if (!current || dirty & /*baseRoute, currentPrefix, url*/ 7 && a_href_value !== (a_href_value = "" + ((!/*baseRoute*/ ctx[1] ? /*currentPrefix*/ ctx[2] : '') + /*url*/ ctx[0]))) {
	...
	function instance$1($$self, $$props, $$invalidate) {
		...
		let { url } = $$props;
		let { baseRoute = false } = $$props;
		let currentPrefix = '';

		prefix.subscribe(value => {
			console.log(value);
			$$invalidate(2, currentPrefix = value || '');
		});
		...
		$$self.$$set = $$props => {
			...
			if ('baseRoute' in $$props) $$invalidate(1, baseRoute = $$props.baseRoute);
			if ('$$scope' in $$props) $$invalidate(4, $$scope = $$props.$$scope);
		};

		return [url, baseRoute, currentPrefix, changeRoute, $$scope, slots];
	}

	class RouterLink extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$1, create_fragment$2, safe_not_equal, { url: 0, baseRoute: 1 });
		}
	}

	/* dashboard\app\component\Sidenav.svelte generated by Svelte v4.2.0 */
