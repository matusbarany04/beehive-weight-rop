var app = (function () {
	...
	function create_fragment$7(ctx) {
		...
		return {
			c() {
				h1 = element("h1");
				h1.textContent = "Test component in action !!!!111";
	...
	function create_fragment$6(ctx) {
		...
		return {
			...
			p(ctx, [dirty]) {
				if (!current || dirty & /*counter*/ 1) set_data(t6, /*counter*/ ctx[0]);
			},
			i(local) {
				if (current) return;
	...
	function create_fragment$2(ctx) {
		...
		return {
			c() {
				...
				attr(a, "href", a_href_value = "/web/dashboard/" + /*url*/ ctx[0]);
			},
			m(target, anchor) {
			...
			p(ctx, [dirty]) {
				...
				if (!current || dirty & /*url*/ 1 && a_href_value !== (a_href_value = "/web/dashboard/" + /*url*/ ctx[0])) {
