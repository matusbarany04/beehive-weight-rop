...
{#if messages}
  <div
    class="shadow shadow-tertiary-300 mx-auto mb-4 flex h-32 flex-col justify-between rounded-lg bg-white p-4 md:h-16 md:flex-row lg:w-5/6"
  >
    <!-- title -->
  ...
  {#each messages as message, index}
    <div
      ...
      class=" shadow shadow-tertiary-300 min-h-48 mx-auto mb-4 flex flex-col justify-between rounded-lg p-4 lg:w-5/6 {message.seen >
      0.5
        ? 'bg-slate-200'
        : 'bg-white'}"
    >
