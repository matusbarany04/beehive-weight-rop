<script>
  ...
  let handler; // DataHandler type specific to TypeScript, in JS just declare variable

  let search = true;
  let rowsPerPage = true;
  let rowCount = true;
  let pagination = true;

  let element; // HTMLElement type specific to TypeScript, in JS just declare variable
