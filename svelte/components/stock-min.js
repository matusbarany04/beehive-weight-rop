...
!function (t) {
  ...
  return function i(s, a, l) {
    ...
    9: [function (t, e, n) {
      "use strict";
      var r = t("events").EventEmitter, o = t("inherits"), s = t("json3"), a = t("./utils/object"), l = function () {
      };
    ...
    14: [function (_, E, t) {
      (function (i) {
        "use strict";
        _("./shims");
        var r, l = _("url-parse"), t = _("inherits"), s = _("json3"), c = _("./utils/random"), e = _("./utils/escape"),
          ...
          m = _("./location"), v = _("./event/close"), b = _("./event/trans-message"), y = _("./info-receiver"),
          g = function () {
          };
    ...
    20: [function (t, e, n) {
      "use strict";
      var r = t("inherits"), o = t("./lib/ajax-based"), i = t("./receiver/eventsource"), s = t("./sender/xhr-cors"),
        a = t("eventsource");
    ...
    22: [function (t, e, n) {
      "use strict";
      var r = t("inherits"), o = t("json3"), i = t("events").EventEmitter, s = t("../version"), a = t("../utils/url"),
        l = t("../utils/iframe"), c = t("../utils/event"), u = t("../utils/random"), f = function () {
        };
    ...
    23: [function (s, a, t) {
      (function (t) {
        "use strict";
        var e = s("inherits"), n = s("./lib/sender-receiver"), r = s("./receiver/jsonp"), o = s("./sender/jsonp");
    ...
    28: [function (t, e, n) {
      "use strict";
      var r = t("inherits"), a = t("../../utils/url"), l = t("./buffered-sender"), c = t("./polling"), u = function () {
      };
    ...
    30: [function (n, u, t) {
      (function (r) {
        "use strict";
        var t = n("inherits"), o = n("../../utils/iframe"), i = n("../../utils/url"), s = n("events").EventEmitter,
    ...
    34: [function (r, c, t) {
      (function (i) {
        "use strict";
        var o = r("events").EventEmitter, t = r("inherits"), s = r("../../utils/event"), e = r("../../utils/browser"),
      ...
      (function (s) {
        (function () {
          ...
          function W(t, l) {
            ...
            var c = t.Number || D.Number, u = t.String || D.String, e = t.Object || D.Object, f = t.Date || D.Date,
              n = t.SyntaxError || D.SyntaxError, E = t.TypeError || D.TypeError, r = t.Math || D.Math,
              o = t.JSON || D.JSON;
