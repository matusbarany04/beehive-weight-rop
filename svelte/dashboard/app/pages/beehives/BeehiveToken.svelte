...
<svelte:head>
  ...
  <meta
    name="Beehive from Token"
    content="This page provides one of the options to add new beehive with token"
  />
</svelte:head>
...
<div
  class="{token
    ? ''
    : 'flex'} rounded-lg bg-white p-5 shadow shadow-tertiary-300"
>
  {#if !token}
